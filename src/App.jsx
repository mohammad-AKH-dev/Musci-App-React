...
function App() {
  ...
  // Fast Forward Next Handler
  const fastForwardNextHandler = () => {
        audioRef.current.currentTime = audioRef.current.currentTime + 5
        setPlay(true)
        playSong()
  }

  // Fast Forward Prev Handler

  const fastForwardPrevHandler = () => {
        audioRef.current.currentTime = audioRef.current.currentTime - 5
        setPlay(true)
        playSong()
  }
        ...
        <div className="music-app">
          <div className="music-app__wrapper">
            <div className="music-app-img__wrapper">
              <img src={songs[index].cover} className="music-app__Img" />
            </div>
            <div></div>
            <div className="music-app__infos">
              ...
              <div className="music-app-infos__wrapper">
                ...
                <div className="fast-forward__next-btn" onClick={()=> fastForwardNextHandler()}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="100%"
                    height="100%"
                ...
                <div className="fast-forward__prev-btn" onClick={() => fastForwardPrevHandler()}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="100%"
                    height="100%"
